...
public class RunnerPattern {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stock.savaDataAvaibelproducts("src/learn_information_expert_with_serialization_example"
                + "/use_information_expert_stock_cash_register_sale_product_desc/"
                + "products_avialable_in_stock.txt");

        Stock.savaDataSpusaniProductu("src/learn_information_expert_with_serialization_example"
                + "/use_information_expert_stock_cash_register_sale_product_desc/"
                + "products_written_off_goods_in_stock.txt");

        Stock.savaDataIncamproducts("src/learn_information_expert_with_serialization_example"
                + "/use_information_expert_stock_cash_register_sale_product_desc/"
        ...
        productDesc = (ArrayList<ProductDesc>) Stock.loadDataAvaibeleproducts
                ("src/learn_information_expert_with_serialization_example"
                        + "/use_information_expert_stock_cash_register_sale_product_desc/"
                        + "products_avialable_in_stock.txt");
